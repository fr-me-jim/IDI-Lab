...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(dial, SIGNAL(valueChanged(int)), widget, SLOT(rotarPatricio(int)));
        QObject::connect(verticalSlider, SIGNAL(valueChanged(int)), widget, SLOT(canviColorT(int)));
